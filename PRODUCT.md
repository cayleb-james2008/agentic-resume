...
This is Cayleb Alvarez-James's static public portfolio and project résumé. It presents selected public engineering projects, dated source-backed examples, and clear limits on what each item proves. A useful result lets a reviewer distinguish established public project evidence from work-in-progress workflows and reach the linked proof without mistaking a source slice or public code for a completed private workflow.

## Positioning

The portfolio pairs public case studies and repository links with dated evidence and explicit limits. It distinguishes the existence of public code or a verified source record from a verified end-to-end workflow, independent AI contribution, employment, customer, adoption, revenue, or company-deployment outcome. This describes the current evidence boundary; it is not an exclusivity or market-leadership claim.

## Operating Context

- The existing product is a static HTML, CSS, and JavaScript website, served under the `/agentic-resume/` base path with relative assets. Its current public Pages source is repository commit `91082127649451e4bd57f75f91cbe89a0e0929a1` (verified 2026-09-25).
- Its exact fourteen page routes are:
  ...
  6. `/agentic-resume/projects/backtestguard.html` — BacktestGuard
  7. `/agentic-resume/projects/replycraft.html` — ReplyCraft
  8. `/agentic-resume/projects/handoffhub.html` — HandoffHub
  9. `/agentic-resume/projects/pipelinerelay.html` — PipelineRelay
  10. `/agentic-resume/projects/onboardpath.html` — OnboardPath
  11. `/agentic-resume/projects/sentineldesk.html` — SentinelDesk
...
- Preserve the existing static stack, fourteen routes, `/agentic-resume/` base path, and working relative assets. The existing one-page PDF is `Cayleb-James-resume.pdf`; it is a project résumé, not a complete career-history record. The current PDF was verified on 2026-09-25 as one page with selectable text.
- The ten Industry AI Suite pages each remain **WIP · INCOMPLETE**, with **Full job · UNVERIFIED** and **AI UNVERIFIED**. Source/evidence status is separate from full-job and AI status:
  ...
  | SearchLift | Source HISTORICAL: an earlier portfolio capture, not current-page or performance evidence. |
...
- The public Industry AI Suite proof link is pinned to commit `a4c1bd3125dce543e75e0d140c487ecb1e4df37f`: [reviewed suite source](https://github.com/cayleb-james2008/industry-ai-suite/tree/a4c1bd3125dce543e75e0d140c487ecb1e4df37f). Public code visibility does not change the ten workflow statuses above.
...
On 2026-09-25 the operator rejected the existing portfolio look. This records a negative preference only; no replacement identity, visual direction, or aesthetic is approved by this document.

## Evidence on Hand

- Current public site source: Pages commit `91082127649451e4bd57f75f91cbe89a0e0929a1`; local `index.html` SHA-256 `3dc889344dd83b6ce798ea349e8361092c4b31907e5d768d44300556b4671795`.
...
4. Preserve the existing public routes and project-only résumé while changes are reviewed locally.

## Accessibility & Inclusion

Future changes must keep the web experience usable at desktop and phone sizes, allow keyboard operation with visible focus, and honor reduced-motion preferences. These are requirements, not a claim that the current site has passed a full accessibility audit.
...
- The rejected visual presentation has no approved replacement in this product record.
