...
## Public systems
- **Industry AI Suite:** ten inspectable source-to-result journeys with a local read-only workbench and a hosted, dated replay. Each shows evidence, uncertainty, and a human handoff. [Public code](https://github.com/cayleb-james2008/industry-ai-suite) · [Recorded lab](https://cayleb-james2008.github.io/agentic-resume/lab/).
...
- **SearchLift:** a dated, bounded read of one portfolio page found 10/10 approved workflow names; AI NOT RUN in that structural review. SearchLift before-state: an older capture found 0/10 approved workflow names. Neither read measures rankings, traffic, or whole-site SEO. [Public source](https://github.com/cayleb-james2008/agentic-resume).
...
- **Full enterprise job · UNVERIFIED for all ten.** Private company, customer, employee, CRM, and organization-asset sources are not present. No revenue, customer use, adoption, company deployment, trade, transfer, message send, or automated consequential decision is claimed.
